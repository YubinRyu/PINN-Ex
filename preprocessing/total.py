...
for i in file_list_py:
    print('Total Domain Data Preprocessing...')
...
total.columns = ['x-coordinate', 'y-coordinate', 'z-coordinate',
                     'Pressure', 'Initiator', 'Monomer', 'Temperature',
                     'x-velocity', 'y-velocity', 'z-velocity',
                     'input-concentration', 'input-temperature', 'domain']

total = total.drop_duplicates(['x-coordinate', 'y-coordinate', 'z-coordinate',
                                       'Pressure', 'Initiator', 'Monomer', 'Temperature',
                                       'x-velocity', 'y-velocity', 'z-velocity'], keep=False)

total = total.astype('float')
total.to_pickle(pardir + '/data/total.pkl')
